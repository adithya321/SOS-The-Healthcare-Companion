...
public class User extends RealmObject {
    ...
    private int d_type;
    private String preferred_unit = "mg/dL";
    @Required
    private String preferred_unit_a1c = "percentage";
    @Required
    private String preferred_unit_weight = "kilograms";
    private String preferred_range = "ADA";
