...
public class ViewActivity extends AppCompatActivity {
    ...
    TextView notificationQuantityText;
    ...
    public void assignReminderValues() {
        ...
        notificationQuantityText.setText(getString(R.string.quantity_show, reminder.getQuantity()));
        ...
        dosage.setText(getString(R.string.dosage_show, reminder.getDosage()));
