...
public class HelpDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    @BindView(R.id.help1_card)
    CardView help1Card;
    @BindView(R.id.help2_card)
    CardView help2Card;
    @BindView(R.id.help3_card)
    CardView help3Card;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        help1Card.setOnClickListener(this);
        help2Card.setOnClickListener(this);
        help3Card.setOnClickListener(this);
        ...
        query.build(json).enqueue(new Callback<InsertResult<EmergencyRecord>, DBException>() {
            ...
            public void onSuccess(InsertResult<EmergencyRecord> response) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(HelpDetailActivity.this, "Emergency reported successfully", Toast.LENGTH_LONG).show();
                    }
                });
            }
            ...
            public void onFailure(final DBException e) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(HelpDetailActivity.this, errMsg, Toast.LENGTH_LONG).show();
                    }
                });
            }
        });
