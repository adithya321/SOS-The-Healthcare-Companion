...
public class FireDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            window.setStatusBarColor(ColorUtils.getDarkVariant(getResources()
                    .getColor(R.color.shortcut_fire)));
        }
        ...
        query.build(json).enqueue(new Callback<InsertResult<EmergencyRecord>, DBException>() {
            ...
            public void onSuccess(InsertResult<EmergencyRecord> response) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(FireDetailActivity.this, "Emergency reported successfully", Toast.LENGTH_LONG).show();
                    }
                });
            }
            ...
            public void onFailure(final DBException e) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(FireDetailActivity.this, errMsg, Toast.LENGTH_LONG).show();
                    }
                });
            }
        });
