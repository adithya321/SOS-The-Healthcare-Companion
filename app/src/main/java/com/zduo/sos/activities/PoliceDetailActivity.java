...
public class PoliceDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bgShape.setColor(getResources().getColor(R.color.glucosio_reading_low));
        GradientDrawable fireShape = (GradientDrawable) fireCircle.getDrawable();
        fireShape.setColor(getResources().getColor(R.color.shortcut_police));
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            window.setStatusBarColor(ColorUtils.getDarkVariant(getResources()
                    .getColor(R.color.shortcut_police)));
        }
        ...
        query.build(json).enqueue(new Callback<InsertResult<EmergencyRecord>, DBException>() {
            ...
            public void onSuccess(InsertResult<EmergencyRecord> response) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(PoliceDetailActivity.this, "Emergency reported successfully", Toast.LENGTH_LONG).show();
                    }
                });
            }
            ...
            public void onFailure(final DBException e) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(PoliceDetailActivity.this, errMsg, Toast.LENGTH_LONG).show();
                    }
                });
            }
        });
